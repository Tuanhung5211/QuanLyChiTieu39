...
public class MainFrame extends JFrame implements Observer {
    ...
    private JPanel createSidebar() {
        ...
        // 🌟 KHẮC PHỤC 1: Khóa chiều cao tối đa của avatarRow để BoxLayout không tạo khoảng trống giãn cách
        avatarRow.setMaximumSize(new Dimension(Integer.MAX_VALUE, avatarRow.getPreferredSize().height));
        topContainer.add(avatarRow);

        // 🌟 KHẮC PHỤC 2: Khoảng cách đệm nhỏ chuẩn bằng đúng 1 dòng (12px) ngay dưới chân Avatar
        ...
        // 🌟 KHẮC PHỤC 3: Khóa cứng chiều cao infoPanel để ép các dòng khít chặt lại với nhau sát chân Avatar
    ...
    public void updateGlobalLanguage(boolean isVN) {
        ...
        // 🌟 KHẮC PHỤC CHÍNH XÁC: Gọi lệnh chuyển ngữ chủ động xuống các Panel ngoài để dứt điểm lỗi chữ đứng im
